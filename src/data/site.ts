...
export const aiWorkflow = {
  ...
  title: "一個團隊的產出，<br />一個人的成本",
  lead: "別人接案是「一個工程師＋一個設計＋一個企劃」，跑幾個月、報價幾十萬。家群用 AI 混合工作流交付——策略的腦＋執行的手，一人成軍，把時間與成本砍一半。",
  roles: [
    { k: "腦", t: "負責想清楚", d: "理解複雜需求、拆解底層任務、規劃執行策略、判斷潛在風險、控制優先級——像 Tech Lead 掌方向。" },
    { k: "手", t: "負責做到底", d: "撰寫與修改程式、Code Review、局部實作、補完細節、處理重複性工程——高執行力，一路做到完。" },
  ],
  proofTitle: "最近一個實戰",
  proofLead: "幾天內、一個人，幫一套線上訂閱系統：",
  proof: [
    "揪出並修好纏了數年的雲端資料同步 bug（客戶資料刪了又復活）",
    "付款與報告全部上雲備份，跨裝置不再遺失",
    "成員資料庫的篩選與後台操作體驗全面升級",
    "順手做完 6 張品牌行銷輪播圖＋社群發文文案",
  ],
